export const exp = [
  {
    ...
    description: 'Developed UAV stereo camera trajectory estimation and 3D reconstruction system using ORB-SLAM3 and MASt3R-SLAM. Integrated ORB-SLAM3 concurrently with YOLOv8 in C++ for real-time UAV navigation. Improved runtime performance by 50% and achieved 90% detection accuracy with custom-labeled data.',
  ...
  },
  {
    ...
    description: 'High-performance UAV image processing using MPI (multi-core processing), OpenMP (multi-threading), and CUDA ORB/SURF with OpenCV C++. Achieved a 300% increase in speed of feature-detection and image stitching processes and decreased the parallel-processing cost by 61% via CUDA.',
