...
const prompt1 = "Give me a short poem about " + getRandomTopic() + ", with at least 15 lines. Only generate the poem and its title, and NOTHING else.";
...
export default function Home() {
  ...
  const generateText = async () => {
    ...
    const prompt = `Give me a short poem about ${newTopic}, with at least 15 lines. Only generate the poem and its title (enclosed in double star **), and NOTHING else. Show emotions.`;
  ...
  return (
    <div>
      <main className="flex min-h-screen flex-col items-center justify-start p-4 sm:p-10 bg-black">
        <div className="z-10 max-w-xl w-full text-center cursor-pointer rounded border border-gray-800 text-white p-5 ms:text-base text-[14px]">
          {/* <p className="whitespace-pre-wrap font-Jura">I am a bot integrated using the Gemini API</p> */}
