...
const prompt = `Give me a short poem about ${newTopic}, with at least 15 lines. Only generate the poem and its title (enclosed in double star **), and NOTHING else. Show emotions and creativity.`;
...
<div className="z-10 max-w-xl w-full text-center cursor-pointer rounded border border-gray-800 text-white p-5 ms:text-base text-[14px] mt-3">
