...
export default function Home() {
  return (
    <div className="grid grid-rows-[1fr_auto] min-h-screen">
      ...
      <div className="grid grid-rows-[0px_1fr] items-center justify-items-center min-h-screen p-4 gap-16 sm:p-10 font-[family-name:var(--font-geist-sans)]">
        <main className="flex flex-col gap-4 row-start-2 items-center sm:items-start" id="main">
          ...
          <p className="text-center font-Jura mr-auto ml-auto" data-aos="zoom-in">
            I am an undergraduate engineering student with experience in embedded systems, scientific programming, computer vision, and web-dev.
          </p>
          ...
          <p className="text-center font-Jura mr-auto ml-auto w-full md:w-3/4" data-aos="zoom-in">
            My work so far consists mostly of image-processing, collision-detection with drones, and physics simulation. As mentioned, I also do web-development, either in vanilla JS with CSS3, or Next.js with Tailwind CSS.
          </p>
          ...
          <a href="https://github.com/Continuum3416" target="_blank" className="social-media" data-aos="fade-in" data-aos-delay="400" data-aos-easing="ease-in-out">
          ...
          <a href="https://www.linkedin.com/in/don-d-le/" target="_blank" className="social-media" data-aos="fade-in" data-aos-delay="600" data-aos-easing="ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
          ...
          <a href="https://discordapp.com/users/750019342518714398" target="_blank" className="social-media" data-aos="fade-in" data-aos-delay="800" data-aos-easing="ease-in-out">
          ...
          <a href="https://www.instagram.com/don.d.le/" target="_blank" className="social-media" data-aos="fade-in" data-aos-delay="1000" data-aos-easing="ease-in-out">
