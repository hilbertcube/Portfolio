    ...
    <div className="grid grid-rows-[1fr_auto] min-h-screen">
      ...
      <div className="grid grid-rows-[0px_1fr] items-center justify-items-center min-h-screen p-4 gap-16 sm:p-10 font-[family-name:var(--font-geist-sans)]">
        <main className="flex flex-col gap-4 row-start-2 items-center sm:items-start" id="main">
          ...
          <div className="text-center font-Jura mr-auto ml-auto text-xl text-blue-700" data-aos="zoom-in" data-aos-once="true">
            SOFTWARE AND WEB DEV
          </div>
          
          <p className="text-center font-Jura mr-auto ml-auto" data-aos="zoom-in" data-aos-once="true">
          ...
          <p className="text-center font-Jura mr-auto ml-auto w-full md:w-3/4" data-aos="zoom-in" data-aos-once="true">
          ...
          <a href="mailto:ledongduu@gmail.com" className="hover:bg-gray-400 p-3 rounded-full transition duration-300 ease-in-out" data-aos="fade-in" data-aos-delay="200" data-aos-easing="ease-in-out" data-aos-once="true">
