  ...
  return (
    <div className="grid grid-rows-[1fr_auto] min-h-screen">
      ...
      <main className="flex flex-col gap-4 row-start-2 items-center sm:items-start" id="main">
        ...
        <a href="https://www.linkedin.com/in/du-le-56623a326/" target="_blank" className="hover:bg-gray-400 p-2 rounded-full transition duration-300 ease-in-out" data-aos="fade-in" data-aos-delay="600" data-aos-easing="ease-in-out">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
    ...
    <div className="">
      ...
      <footer className="bg-black text-center text-white font-Jura pb-6">Made with Next, Tailwind, and AOS.</footer>
    </div>
