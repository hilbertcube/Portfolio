...
export default function EventCard({ info }) {
  return (
    <a className="group hover:bg-zinc-900 transition-all duration-200 cursor-pointer font-Jura flex flex-col md:flex-row bg-inherit shadow-md rounded-lg p-4 mb-4" data-aos="fade-up" href={info.link} target="_blank" rel="noopener noreferrer">
